...
<section class="theme-block theme-blog theme-blog-large theme-bg-grey">
	...
	<div class="container-full">
        ...
        <?php else: ?>  
            ...
            <div class="col-lg-<?php echo ( !is_active_sidebar( 'sidebar-main' ) ? '12' :''.esc_attr($container).'' ); ?> col-md-<?php echo ( !is_active_sidebar( 'sidebar-main' ) ? '12' :''.esc_attr($container).'' ); ?> col-sm-12" style="padding: 0;">
